...
- Allow the direct Fronius controller to coordinate multiple Marstek batteries in one aggregate feedback loop while keeping reachable batteries operating when another battery stops responding.
